module.exports = {
    flavor:
        "Flavor represents the coffee's principal character, " +
    ...
    acidity:
        'Acidity is often described as "brightness" when favorable ' +
    ...
    body:
        "The quality of Body is based upon the tactile feeling of the " +
        ...
        "quite different.",
    sweetness:
        "Sweetness refers to a pleasing fullness of flavor as " +
    ...
    aftertaste:
        "Aftertaste is defined as the length of positive flavor " +
    ...
    overall:
        "The “overall” scoring aspect is meant to reflect the " +
