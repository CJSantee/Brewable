...
const SelectIcon = ({ route, navigation }) => {
    ...
    const updateBeans = () => {
        db.transaction(
            (tx) => {
                tx.executeSql("UPDATE beans SET photo_uri = ? WHERE id = ?;", [
                    selectedIcon ? selectedIcon : uri,
                    beans_id,
                ]);
            },
            (e) => console.log(e),
    ...
    function rightOnPress() {
        if (parent === "NewBeans") {
            navigation.navigate(parent, {
                photo_uri: selectedIcon ? selectedIcon : uri,
            });
                    ...
                    <View style={styles.iconsList}>
                        {uri && !selectedIcon ? (
                            ...
                            >
                                ...
                                >
                                    <Image
                                        source={require("../../assets/images/CameraBag.png")}
                                        style={{
                                            width: imageSize * 0.7,
