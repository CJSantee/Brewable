module.exports = {
    ...
    "final score marked on the horizontal tick-mark scale should reflect "+
    ...
    "steeps. Specific aromas can be noted under “qualities” and the "+
    "intensity of the dry, break, and wet aroma aspects noted on the 5- "+
    "point vertical scales. The score finally given should reflect the "+
    "preference of all three aspects of a sample’s Fragrance/Aroma.",
    ...
    "equally high preference scores although their intensity rankings "+
    ...
    "as soft drinks, but will affect other flavor attributes. 2 points are "+
    "awarded for each cup displaying this attribute for a maximum "+
    "score of 10 points.",
