...
function mapRating(value) {
    ...
    else return Math.floor((value - 10) / 20) + 1;
}
            ...
            (tx) => {
                tx.executeSql(
                    ...
                    [
                        ...
                        beans.origin,
                        beans.roast_level,
                        beans.roast_date.toJSON(),
                        beans.price,
                        beans.weight,
                        beans.weight_unit,
                        beans.flavor_notes,
                        mapRating(beans.rating),
                        beans.photo_uri,
                        beans.favorite,
                    ]
                );
            ...
            <KeyboardAwareScrollView>
                ...
                <TableView header='Roast'>
                    ...
                    <TextFieldRow
                        ...
                        onChange={(value) =>
                            setBeans({ ...beans, roast_level: value })
                        }
                    />
                </TableView>
                <TableView header='Bag'>
                    <DatePickerRow
                        title='Roast Date'
                        value={beans.roast_date}
                        onChange={(value) => {
                            setBeans({ ...beans, roast_date: value });
                        }}
                    />
                    <TextFieldRow
                        title='Weight'
                    ...
                    >
                        <SegmentedControl
                            ...
                            onValueChange={(value) =>
                                setBeans({ ...beans, weight_unit: value })
                            }
                            style={{ width: 100 }}
                    ...
                    <RowItem
                        ...
                        onPress={() =>
                            navigation.navigate("SelectFlavors", {
                                parent: "NewBeans",
                                flavor_notes: beans.flavor_notes,
                            })
                        }
                    >
                        <Feather
                ...
                <TableView>
                    ...
                    >
                        ...
                        >
                            ...
                            <FontAwesome
                                name={
                                    beans.favorite === 1 ? "heart" : "heart-o"
                                }
                                color={colors.interactive}
                            />
                        </View>
