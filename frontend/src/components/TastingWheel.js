        ...
        <View style={style}>
            <Svg width={width} height={height} viewBox='0 0 280 280'>
                <Defs>
                    <Mask id='mask'>
                        <Rect
                            ...
                            fill='white'
                        />
                        <Polygon points={shape(values)} fill='black' />
                    </Mask>
                </Defs>
                ...
                {displayText ? ( // Body
                    ...
                    >
                        {abbreviated ? abbreviations[0] : descriptors[0]}
                    </Text>
                ) : (
                    <View />
                )}
                ...
                {displayText ? ( // Aftertaste
                    <Text
                        ...
                        fontSize={abbreviated ? 22 : 12}
                    >
                        {abbreviated ? abbreviations[1] : descriptors[1]}
                    </Text>
                ) : (
                    <View />
                )}
                ...
                {displayText ? ( // Sweetness
                    <Text
                        ...
                        fontSize={abbreviated ? 22 : 12}
                    >
                        {abbreviated ? abbreviations[2] : descriptors[2]}
                    </Text>
                ) : (
                    <View />
                )}
                ...
                {displayText ? ( // Aroma
                    <Text
                        ...
                        fontSize={abbreviated ? 22 : 12}
                    >
                        {abbreviated ? abbreviations[3] : descriptors[3]}
                    </Text>
                ) : (
                    <View />
                )}
                ...
                {displayText ? ( // Flavor
                    <Text
                        ...
                        fontSize={abbreviated ? 22 : 12}
                    >
                        {abbreviated ? abbreviations[4] : descriptors[4]}
                    </Text>
                ) : (
                    <View />
                )}
                ...
                {displayText ? ( // Acidity
                    <Text
                        ...
                        fontSize={abbreviated ? 22 : 12}
                    >
                        {abbreviated ? abbreviations[5] : descriptors[5]}
                    </Text>
                ) : (
                    <View />
                )}
