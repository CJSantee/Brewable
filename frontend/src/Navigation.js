    ...
    return (
        <Tab.Navigator screenOptions={({ route }) => ({
            tabBarIcon: ({ focused, size }) => {                    
                if (route.name === "Beans")
                    return <CoffeeBean width={size} height={size} style={{color: focused?colors.interactive:colors.placeholder}}/>
                else 
                    return <Feather name="coffee" size={size} color={focused?colors.interactive:colors.placeholder}/>
            },
    ...
    return (
        ...
        <NavigationContainer theme={user_preferences.theme === "Light" ? LightTheme : DarkTheme}>
            ...
            <Stack.Navigator screenOptions={{headerShown: false}}>
                ...
                <Stack.Screen name="DeveloperPage" component={DeveloperPage}/>
